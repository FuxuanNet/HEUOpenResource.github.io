...
export default defineUserConfig({
  ...
  bundler: webpackBundler({
    configureWebpack: () => {
      ...
      if(NODE_ENV === 'production'){
        return {
          output: {
            publicPath: 'https://cdn.jsdelivr.net/gh/HEUOpenResource/HEUOpenResource.github.io@gh-pages/'
          },
          resolve: {
            //配置路径别名
            alias: {
  ...
  theme: plumeTheme({
    ...
    changelog: {
      maxCount: 20,
      repoUrl: 'https://github.com/HEUOpenResource/HEUOpenResource.github.io',
