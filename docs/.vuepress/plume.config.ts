...
export default defineThemeConfig({
  ...
  social: [
    { icon: 'github', link: 'https://github.com/HEUOpenResource' },
    { icon: 'telegram', link: 'https://t.me/+l17qIX7cFRNmNjg1' },
  ],
  ...
  copyright:{
    ...
    author: {name:  "HEUOpenResource",url:  "https://github.com/HEUOpenResource"},
    creation: "original",
  },
